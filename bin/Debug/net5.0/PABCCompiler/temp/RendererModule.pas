...
//uses FigureModule, AxesModule, System.Windows.Media;
...
procedure FillRectangleJS(x,y,w,h:real; fillColor:Color);
begin
  output += 'cx.fillStyle = "rgb('+fillColor.R+','+fillColor.G+','+fillColor.B+')";'+
	          'cx.fillRect('+x+','+y+','+w+','+h+');';
end;
...
begin
  output += 'cx.fillStyle = "rgb('+fillColor.R+','+fillColor.G+','+fillColor.B+')";'+
            'cx.strokeStyle = "rgb('+strokeColor.R+','+strokeColor.G+','+strokeColor.B+')";'+
            'cx.lineWidth = '+width+';'+
	          'cx.fillRect('+x+','+y+','+w+','+h+');'+
...
procedure DrawLineJS(x1,y1,x2,y2:real; lineColor:Color; width:real);
begin
  output += 'cx.strokeStyle = "rgb('+lineColor.R+','+lineColor.G+','+lineColor.B+')";'+
            'cx.lineWidth = '+width+';'+
            'cx.beginPath();'+
            'cx.moveTo('+x1+','+y1+');'+
            'cx.lineTo('+x2+','+y2+');'+
...
procedure TextOutJS(x,y:real; text: string; fnt:FontOptions);
begin
  output += 'cx.font = "'+ (fnt.Size/96*72) +'pt '+fnt.Name+'";'+
            'cx.fillStyle = "black";'+
            'cx.textAlign = "left";'+
            'cx.textBaseline = "top";'+
